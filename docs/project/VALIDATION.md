...
- **Waiver:** none
- **Follow-up:** KWin visual proof of the insertion line + toast (no isolated-Plasma session in this environment); list auto-scroll while dragging near edges not attempted.
