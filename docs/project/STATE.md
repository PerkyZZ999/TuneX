...
## Current evidence
- Latest passed gate: `rust-tc sonar` for W-015 (QG OK)
- Latest validation entry: 2026-09-10 W-015 artwork pipeline green (87 tests, QG OK)
...
- Repo reality: S1 done; S2 through W-015 done; W-016 (library QML models + browse views) next.
...
## Next action
- W-016: library QML models + browse views (artists/albums/tracks, virtualized, placeholders).
