...
## Current evidence
- Latest passed gate: `rust-tc sonar` for W-016 (QG OK)
- Latest validation entry: 2026-09-10 W-016 browse models + views green (111 tests, QG OK)
...
- Repo reality: S1 done; S2 through W-016 done; W-017 (folders UI + scan progress) next.
...
## Next action
- W-017: library folders UI (native add/remove, scan progress) + restart persistence check.
