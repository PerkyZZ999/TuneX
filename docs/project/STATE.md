...
## Current evidence
- Latest passed gate: `rust-tc sonar` for W-030 last-track restore (QG OK, 81.2% new coverage)
- Latest validation entry: 2026-09-10 S4 W-030 last-track + position restore (see VALIDATION.md)
...
- Repo reality: S1+S2+S3 done; S4 active (W-026–W-030 done, W-031 gate next).
...
## Next action
- W-031: S4 gate — keyboard walkthrough + offline run + a11y/contrast/blur-off; close or loop back.
