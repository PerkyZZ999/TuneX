...
## Current evidence
- Latest passed gate: `rust-tc sonar` for W-022 (QG OK)
- Latest validation entry: 2026-09-10 W-022 queue UI green (165 tests, QG OK)
...
- Repo reality: S1+S2 done; S3 active (W-019–W-022 done, W-023 next).
...
## Next action
- W-023: playlists backend (schema v4, CRUD, reorder, dangling-as-missing, restart persistence).
